...
export default function Card(props) {
  ...
  return (
    <div className='card text-white bg-dark mb-3'>
      ...
      <img src={photo.photo} alt='Photo' className='card-img-top' />
      <div className='card-body'>
        <div className='row justify-content-between'>
          <div className='col-2'>
            <div
              ...
              <button
                ...
                onClick={() => {
                  if (!photo.liked) {
                    setPhoto({ ...photo, liked: true, likes: photo.likes++ });
                  }
                }}>
                <svg
                  width='1em'
              ...
              <Link href={`/user/${photo.userId}`}>
                <button className='btn btn-dark pt-0 text-left'>
                  <svg
                    width='1em'
                    height='2em'
                    viewBox='0 0 16 16'
          ...
          <div className='col-1'>
            <button
              className={`btn btn-dark pt-0 text-left ${
        ...
        <p className='card-title font-weight-bolder'>Likes: {photo.likes}</p>
